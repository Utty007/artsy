  ...
  return (
    <div className='md:border border-black md:p-8 mx-8 md:mx-16 my-8 text-left md:text-center'>
        ...
        <div className='flex flex-col md:flex-row items-start md:items-center gap-4 md:justify-center'>
            <input className='border border-black text-[#333] px-4 py-2 outline-none' type="email" placeholder='ENTER YOUR EMAIL' name="Mail" /> <button className='bg-black text-white px-4 py-2'>SUBSCRIBE</button>
        </div>
    </div>
  )
}
